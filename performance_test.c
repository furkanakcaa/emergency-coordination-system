...
// void performanceTesti(HashTable *ht, BST *bst)
// {
...
//         double htSure = olcSure(bas, bitis, frekans) / tekrar;

//         QueryPerformanceCounter(&bas);
//         for (int i = 0; i < tekrar; i++)
//             searchBST(bst->root, (rand() % 5) + 1);
//         QueryPerformanceCounter(&bitis);
//         double bstSure = olcSure(bas, bitis, frekans) / tekrar;
...
//         }
//         QueryPerformanceCounter(&bitis);
//         double bstEklemeSure = olcSure(bas, bitis, frekans) / tekrar;
...
//         }
//         QueryPerformanceCounter(&bitis);
//         double htEklemeSure = olcSure(bas, bitis, frekans) / tekrar;

//         QueryPerformanceCounter(&bas);
//         for (int i = 0; i < tekrar; i++)
//             bst->root = deleteBST(bst->root, (rand() % 5) + 1);
//         QueryPerformanceCounter(&bitis);
//         double bstSilmeSure = olcSure(bas, bitis, frekans) / tekrar;

//         QueryPerformanceCounter(&bas);
//         for (int i = 0; i < tekrar; i++)
//             deleteRecord(ht, rand() % n);
//         QueryPerformanceCounter(&bitis);
//         double htSilmeSure = olcSure(bas, bitis, frekans) / tekrar;

//         printf("\n*** %d Kayit ***\n", n);
//         printf("Hash Table arama : %.6f ms\n", htSure);
//         printf("BST arama        : %.6f ms\n", bstSure);
//         printf("Hash Table ekleme: %.6f ms\n", htEklemeSure);
//         printf("BST ekleme       : %.6f ms\n", bstEklemeSure);
//         printf("Hash Table silme : %.6f ms\n", htSilmeSure);
//         printf("BST silme        : %.6f ms\n", bstSilmeSure);
//     }
// }
